...
namespace Horus
{
	...
	{
		HE_CORE_INFO("Application: Constructor de la aplicación Horus.");
	}


	Application::~Application()
	{
		HE_CORE_INFO("Application: Destructor de la aplicación Horus.");
		Shutdown();
	}
	...
	bool Application::Initialize() 
	{
		...
		// Establecer el puntero de usuario para acceder a la aplicación desde el callback
		...
		HE_CORE_INFO("Application: Versión de OpenGL: {0}", (const char*)glGetString(GL_VERSION));
		HE_CORE_INFO("Application: Inicialización de OpenGL completa.");
